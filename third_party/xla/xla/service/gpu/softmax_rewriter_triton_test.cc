...
TEST_F(
    SoftmaxRewriterTritonTest,
    FusesBinaryElementwiseIfIntermediateDiamondOpAlongBatchDimIsBroadcastAsOneDimParameter) {  // NOLINT(whitespace/line_length)
  const std::string hlo_string = R"(
HloModule h1
...
TEST_F(
    SoftmaxRewriterTritonTest,
    DoesNotFuseBinaryElementwiseIfIntermediateDiamondOpAlongReduceDimIsBroadcastAsOneDimParameter) {  // NOLINT(whitespace/line_length)
  const std::string hlo_string = R"(
HloModule h1
