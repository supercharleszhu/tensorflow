...
// transformation to CollectivePermuteStart with one input and without any
// context data.
//
...
// encountered pipelineable CollectivePermute for pipelining. Then, we if there
// is another pipelineable CollectivePermute that forms a forward or backward
